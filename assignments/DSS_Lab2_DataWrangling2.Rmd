---
title: "Lab #2: Data Wrangling Part 2"
...
In this lab, we will practice working with several datasets to become comfortable with R. To submit your answer, you'll need to edit this markdown document (you can copy and paste the text form [this link](https://github.com/dssoc/dssoc.github.io/raw/master/assignments/DSS_Lab2_DataWrangling2.Rmd) into a new `.Rmd` file or write a new one from scratch. If you copy and paste, Rremember to change the "author" field above to your name. After you've edited it, save it and then send it to your TA via direct message on Slack.
