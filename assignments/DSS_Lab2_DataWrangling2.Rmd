...
(2) `artist_wiki`: 'artist_wikipedias.Rdata' is a table of Grammy nominee names and their wikipedia pages. 

In future assignments, we will use these tables to work with the Spotify API. For now, we will use them in a set of exercises that correlate closely with R for Data Science, chapters 9 - 13: https://r4ds.had.co.nz/wrangle-intro.html
...
#### Exercise 1: Often, before working with new datasets or after performing a maniupuation, you will want to take a look at them. Demonstrate at least two ways to view all columns and rows of the `nominees` table. 
```{r}
# your answer here
```
<br/>
