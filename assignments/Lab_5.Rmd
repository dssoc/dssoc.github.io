...
**5. Using the `candidates_flw_am` adjacency matrix (a data frame), create a graph (network) object. Make sure to include information about the edge weights (i.e. the number of accounts shared in common).**
```{r}
# Yor answer here or in text.
