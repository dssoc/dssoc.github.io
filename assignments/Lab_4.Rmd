...
**ex2. Write a function to compute the birth decade for the birthyear of each politician. Then write a function to generate a label for each decade. Use these functions within the mutate function to create new columns in the congress dataframe.**
```{r}
...
congress %>% 
  ...
  select(birthdec, birthdec_label) %>% 
  head()
```
<br/>
