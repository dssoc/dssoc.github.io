...
**5. Use `ggplot` to create [box plots](https://www.r-graph-gallery.com/boxplot.html) or [violin plots](https://www.r-graph-gallery.com/violin.html) showing the popularity by `is_pop` and `is_rap`. What can you say about the data from these plots?**
```{r}
# Your answer here
```
<br/>
