...
**7. Are there other unmeasured variables that might act as confounders we could not include in the model? For instance, perhaps our measurement pop genre categorization actually captures some other aspect of the song that Spotify uses to generate the measure of popularity. Name *two*.**
```
# Your answer here
```


**8. How could you use statistical modeling in the final project you have been developing? What inferences could you make from your data?**
```
# Your answer here
```
