...
**4. For each of the top-three tf-idf tokens, extract up to five tweets with the highest number of retweets that include the token. Based on the context provided in these Tweets, give a quick sentence about what they mean. Do they fit your hypotheses from the question before?**
```{r}
# your answer here
```
```
