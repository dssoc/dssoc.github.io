...
**1. Use the [documentation website](https://www.rdocumentation.org/) or the helper functions in R (?function_name) to look up the `mean` function, and describe each of its arguments and what they do in your own words. You can write comments in a code block by including a "#" character at the beginning of the line.**
```
