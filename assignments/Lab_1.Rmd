...
**1. Use the [documentation website](https://www.rdocumentation.org/) or the helper functions in R to look up the `mean` function, and describe each of its arguments and what they do.**
```
