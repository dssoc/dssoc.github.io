...
library(tidyverse)
load("data/grammy_nominees_20102020.Rdata")
load("data/grammy_winners_20102020.Rdata")
load("data/artist_wikipedia.Rdata")
```
<br/>
...
# your answer here
#nn <- nominees %>% 
  #mutate(num = album_oty + song_oty + new_artist_oty +record_oty) %>%
  #pivot_longer(performer1:performer4, names_to = "performer_type", values_to = "performer") %>% 
  #group_by(performer) %>% 
  #count() %>% ungroup()# %>% 
  
  #select(album_oty, song_oty, new_artist_oty, record_oty, performer)# %>%
  
  #select(number_nominees, performer)
